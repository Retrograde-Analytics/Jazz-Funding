...
mytext <- paste(
  ...
  "% of Revenue is Grants/Contributions:", round(data$percent_grants, digits = 2), "\n",
...
This study and dashboard was created by Jazz bassist and data nerd [Nicholas Krolak](https://www.nicholaskrolak.com). 

Founder of [Retrograde Analytics](https://www.retrograde-analytics.com), a data research and analytics firm that perfroms data tasks and projects for nonprofit organizations and small businesses whose work benefits arts/culture, sustainability, and civics in order to harness the power of data for the greater good.

[Retrograde Analytics](https://www.retrograde-analytics.com) specializes in:

- data collection
- [network analysis](https://retrograde-analytics.github.io/Blue_Mitchell/)
- [geospatial data](https://retrograde-analytics.github.io/PHL-Judges/)
- [interactive dashboard creation](https://retrograde-analytics.github.io/311/)
- customized research
...
grants_dist_text <- paste(
  "Org: ", data$org_name, "\n", 
  "Grants and Contributions: ", format(data$grants_and_contributions, big.mark = ",", scientific = FALSE), "\n",
  "Type: ", data$org_type, sep="")

grants_dist <- ggplot(data, aes(x=reorder(org_name, -grants_and_contributions), y=grants_and_contributions/1000000, fill=org_type, text=grants_dist_text)) + 
  geom_bar(stat = "identity", width=.5, show.legend = FALSE) +
  scale_fill_manual(values = c("#FF9900", "#1b98e0")) +
  ggtitle('Total Grants/Contributions by Organization') +
  ylab('millions (usd)') +
  theme(plot.title = element_text(size=9, hjust=.5),
        axis.title.x=element_blank(),
        axis.ticks.x=element_blank(),
...
### Grant/Contribution Dollars Recieved per Fundraising Dollar
```{r}

grant_fund_dist_text <- paste(
  "Org: ", data$org_name, "\n", 
  "Grant/Contribution Dollars Recieved per Fundraising Dollar Spent: ", format(data$grant_dollars_per_fundrasing_dollar, big.mark = ",", scientific = FALSE), "\n",
  "Type: ", data$org_type, sep="")
...
grant_fund_dist <- ggplot(data, aes(x=reorder(org_name, -grant_dollars_per_fundrasing_dollar), y=grant_dollars_per_fundrasing_dollar, fill=org_type, text=grant_fund_dist_text)) + 
  geom_bar(stat = "identity", width=.5, show.legend = FALSE) +
  scale_fill_manual(values = c("#FF9900", "#1b98e0")) +
  ggtitle('Grant/Contribution Dollars Recieved per Fundraising Dollar Spent by Organization') +
  ylab('(usd)') +
  theme(plot.title = element_text(size=9, hjust=.5),
        axis.title.x=element_blank(),
        axis.ticks.x=element_blank(),
...
perc_grants_dist_text <- paste(
  "Org: ", data$org_name, "\n", 
  "Percent Revenue from Grants/Contributions: ", format(data$percent_grants, big.mark = ",", scientific = FALSE), "\n",
  "Type: ", data$org_type, sep="")
...
perc_grants_dist <- ggplot(data, aes(x=reorder(org_name, -percent_grants), y=percent_grants, fill=org_type, text=perc_grants_dist_text)) + 
  geom_bar(stat = "identity", width=.5, show.legend = FALSE) +
  scale_fill_manual(values = c("#FF9900", "#1b98e0")) +
  ggtitle('Percent of Revenue from Grants/Contributions by Organization') +
  ylab('percent %') +
  theme(plot.title = element_text(size=9, hjust=.5),
        axis.title.x=element_blank(),
        axis.ticks.x=element_blank(),
...
grants_mean <- ggplot(mean_data1, aes(x=org_type, y=grants_and_contributions/1000000, fill=org_type)) +
  geom_bar(stat = 'identity', width=0.2) +
  scale_fill_manual(values = c("#FF9900", "#1b98e0")) +
  ggtitle("Average Grant/Contribution Revenue") +
  geom_text(aes(label = round(grants_and_contributions/1000000, digits=2)), vjust = -.25, size=2) +
  ylab('millions (usd)') +
  ylim(0,40) +
  theme(plot.title = element_text(size=6, hjust=.5),
        axis.title.x=element_blank(),
...
percent_grants_mean <- ggplot(mean_data1, aes(x=org_type, y=percent_grants, fill=org_type)) +
  geom_bar(stat = 'identity', width=0.2) +
  scale_fill_manual(values = c("#FF9900", "#1b98e0")) +
  ggtitle("Average Percent of Revenue from Grants/Contributions") +
...
grants_per_fundraising_mean <- ggplot(mean_data1, aes(x=org_type, y=grant_dollars_per_fundrasing_dollar, fill=org_type)) +
  geom_bar(stat = 'identity', width=0.2) +
  ggtitle("Average Grant/Contribution Dollars per Fundraising Dollar") +
  scale_fill_manual(values = c("#FF9900", "#1b98e0")) +
...
grants_sum <- ggplot(sum_data1, aes(x=org_type, y=grants_and_contributions/1000000, fill=org_type)) +
  geom_bar(stat = 'identity', width=0.2) +
  scale_fill_manual(values = c("#FF9900", "#1b98e0")) +
  ggtitle("Total Grant/Contribution Revenue") +
  geom_text(aes(label = round(grants_and_contributions/1000000, digits=2)), vjust = -.25, size=2) +
  ylab('millions (usd)') +
  ylim(0,2000) +
  theme(plot.title = element_text(size=7, hjust=.5),
...
- 897.53% in <B>Grant/Contribution Revenue</B>
...
- $1.09 billion in <B>Grants/Contributions</B>
...
- $121 million in <B>Grants/Contributions</B>
...
- <B>Grant and Contribution Revenue</B> Income from grants/donations/contributions
...
- <B>Grant/Contribution Dollar per Fundraising Dollar</B> Return on investment of fundraising expenses
- <B>Percent of Revenue from Grants/Contributions</B> Proportion of Grant Funds to Total Revenue
